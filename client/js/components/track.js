            ...
            return (
                <div className="track">
                    ...
                    <span className={"track--voting" + (this.props.vote  === true ? ' enabled' : '' )}>
                        ...
                        <span className="track--vote-controls">
                            <span className="track--downvote" onClick={this.handleDownVote}>-</span>
                            <span className="track--upvote" onClick={this.handleUpVote}>+</span>
                        </span>
                    </span>
